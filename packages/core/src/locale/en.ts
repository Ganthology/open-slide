...
export const en: Locale = {
  ...
  thumbnailRail: {
    ...
    deletePage: 'Delete',
    hidePage: 'Hide when presenting',
    showPage: 'Show when presenting',
    hiddenIndicator: 'Hidden when presenting',
    pageActionsAria: 'Page {n} actions',
    toastDuplicated: 'Duplicated page {n}',
    toastDeleted: 'Deleted page {n}',
    toastHidden: 'Hidden page {n} when presenting',
    toastShown: 'Page {n} visible when presenting',
    toastDuplicateFailed: 'Could not duplicate page',
    toastDeleteFailed: 'Could not delete page',
    toastHideFailed: 'Could not update page visibility',
