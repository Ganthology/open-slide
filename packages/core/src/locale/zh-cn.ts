...
export const zhCN: Locale = {
  ...
  themes: {
    ...
    copyThemeMarkdownAria: '复制主题 Markdown',
    toastCopyAddThemeSuccess: '已复制安装命令',
    toastCopyAddThemeFailed: '无法复制安装命令',
    toastCopyThemeMarkdownSuccess: '已复制主题规范',
    toastCopyThemeMarkdownFailed: '无法复制主题规范',
  },
};
